    ...
    render() {
        return (
            ...
            {/*Fatigue*/}
                ...
                { this.props.all.fatigue === undefined ? '-' : <h3>{Math.round(this.props.all.fatigue[this.props.all.fatigue.length-1])}</h3>}
                </div>
            ...
            <div className='container' style={{height:'90px',width:'110px',backgroundColor:'green',borderRadius:'8px',zIndex:10}} >
                <div className='row justify-content-center align-items-center' style = {{height:'70%'}}>
                { this.props.all.freshness === undefined ? '-' : <h3>{Math.round(this.props.all.freshness[this.props.all.freshness.length-1])}</h3>}
            ...
            {/*Fitness*/}
                ...
                <div className='row justify-content-center align-items-center' style = {{height:'70%'}}>
                { this.props.all.fitness === undefined ? '-' : <h3>{Math.round(this.props.all.fitness[this.props.all.fitness.length-1])}</h3>}
