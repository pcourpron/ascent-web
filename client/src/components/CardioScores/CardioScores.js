    ...
    render() {
        return (
            ...
            {/*Fatigue*/}
                ...
                { this.props.all.fatigue === undefined ? <img alt='loading' src='https://loading.io/spinners/equalizer/lg.equalizer-bars-loader.gif' style={{height:'60px'}}/> : <h3>{Math.round(this.props.all.fatigue[this.props.all.fatigue.length-1].y)}</h3>}
                </div>
            ...
            <div className='container' style={{height:'90px',width:'110px',backgroundColor:'green',borderRadius:'8px',zIndex:10}} >
                <div className='row justify-content-center align-items-center' style = {{height:'70%'}}>
                { this.props.all.freshness === undefined ? <img alt='loading' src='https://loading.io/spinners/equalizer/lg.equalizer-bars-loader.gif' style={{height:'60px'}}/> : <h3>{Math.round(this.props.all.freshness[this.props.all.freshness.length-1].y)}</h3>}
            ...
            {/*Fitness*/}
                ...
                <div className='row justify-content-center align-items-center' style = {{height:'70%'}}>
                { this.props.all.fitness === undefined ? <img alt='loading' src='https://loading.io/spinners/equalizer/lg.equalizer-bars-loader.gif' style={{height:'60px'}}/> : <h3>{Math.round(this.props.all.fitness[this.props.all.fitness.length-1].y)}</h3>}
